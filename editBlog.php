...
if ($db->getBlogById($_GET["blog"]) != false) {
    $blog = $db->getBlogById($_GET["blog"]);
    $blogCategories = $db->getAllCategoriesToBlog($_GET["blog"]);
...
for ($i = 0; $i < count($allCategories); $i++) {
    ...
    $e = "
    <div class='category'>
        <input name='categories[$category]' value='$category' type='checkbox' $checked>
...
<div class="container-fluid w-100 h-90 d-flex">
    ...
    <div class="card m-2 w-75">
        ...
        <div class="card-body">
            <form class="h-100" action="<?php echo $_SERVER['PHP_SELF'] . "?blog=" . $_GET["blog"]; ?>" method="post" enctype="multipart/form-data">
